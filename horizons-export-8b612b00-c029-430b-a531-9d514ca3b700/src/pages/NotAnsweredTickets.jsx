...
const initialChatMessages = {
  ...
  3: [
    {
      sender: 'B',
      text: "Hi, I have a question about my recent invoice. It seems higher than expected.",
      time: "8h",
      isUser: false,
      seen: false,
    }
...
function NotAnsweredTickets() {
  ...
  return (
    <>
      <Helmet>
        <title>Not Answered Tickets - Help Desk</title>
        <meta name="description" content="View and manage all not answered customer conversations." />
      </Helmet>
      <div className="flex w-full h-full">
          ...
          <div className="p-3 border-b border-gray-200 flex-shrink-0">
            <div className="flex justify-between items-center">
              <Button variant="ghost" className="font-bold">
                {conversations.length} Not Answered <ChevronDown className="w-4 h-4 ml-1" />
              </Button>
        ...
        >
          ...
          <div className="flex-1 overflow-y-auto p-4">
             ...
             {selectedConversation.id === 1 && chatMessages[1]?.length === 1 && <AiSummary />}
          </div>
...
export default NotAnsweredTickets;